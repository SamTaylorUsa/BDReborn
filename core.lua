...
local lang = redis:get(hash) 
     if not lang then
	 text = '_Welcome To_ *Group Panel*'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text = "🔰Lock list🔰", callback_data="/locklist:"..GP_id},
		},
		{
			{text = "🔖media Lock🔖", callback_data="/medialist:"..GP_id}
		},			
		{
			{text = '⚜️Group settings⚜️', callback_data = '/more:'..GP_id}
		},
		{
			{text = '🔮More settings🔮', callback_data = '/moresettings:'..GP_id}
		},
		{
			{text = '🌐Language🌐', callback_data = '/lang:'..GP_id}
		},		
		{
			{text = '💎payment💎', url = 'http://webvps.blog.ir/post/درگاه-پرداخت-بلک'},
			{text = '🎗Support🎗', url = 'https://t.me/GODILOVEYOUME2'}
		},		
		{
  ...
  elseif lang then
	 text = '_به پنل بلک خوش امدید_'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text = "🔰لیست قفلی🔰", callback_data="/locklist:"..GP_id},
		},
		{
			{text = "🔖قفل رسانه🔖", callback_data="/medialist:"..GP_id}
		},		
		{
			{text = '⚜️تنظیمات گروه⚜️', callback_data = '/more:'..GP_id}
		},
		{
			{text = '🔮تنظیمات بیشتر🔮', callback_data = '/moresettings:'..GP_id}
		},
		{
			{text = '🌐زبان🌐', callback_data = '/lang:'..GP_id}
		},		
		{
			{text = '💎پرداخت💎', url = 'http://webvps.blog.ir/post/درگاه-پرداخت-بلک'},
			{text = '🎗پشتیبانی🎗', url = 'https://t.me/GODILOVEYOUME2'}			
		},
		{
...
local settings = data[tostring(GP_id)]["settings"]
 ...
 text = '_Welcome To_ *More Settings*'
	...
	keyboard.inline_keyboard = {
		{
			{text = ' Flood Sensitivity ', callback_data = 'black'}
		},
		{
			{text = "🔺", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="black"},
			{text = "🔻", callback_data='/flooddown:'..GP_id}
		},
		{
			{text = ' Character Sensitivity ', callback_data = 'black'}
		},
		{
			{text = "🔺", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="black"},
			{text = "🔻", callback_data='/chardown:'..GP_id}
		},
		{
			{text = ' Flood Check Time ', callback_data = 'black'}
		},
		{
			{text = "🔺", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="black"},
			{text = "🔻", callback_data='/floodtimedown:'..GP_id}
		},
		{
			{text = ' Back ', callback_data = '/panel:'..GP_id}
		}				
	}
   elseif lang then
		if tostring(settings.checkmsg) == "ban" then
 ...
 text = '_به تنظیمات بیشتر خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = ' حداکثر پیام های رگبار ', callback_data = 'black'}
		},
		{
			{text = "🔺", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="black"},
		...
		{
			{text = ' حداکثر حروف مجاز ', callback_data = 'black'}
		},
		{
			{text = "🔺", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="black"},
		...
		{
			{text = ' زمان بررسی پیام های رگبار ', callback_data = 'black'}
		},
		{
			{text = "🔺", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="black"},
		...
		{
			{text = ' بازگشت🔚 ', callback_data = '/panel:'..GP_id}
		}				
	}
   end
    edit_inline(msg.message_id, text, keyboard)
...
local lang = redis:get(hash) 
 ...
 text = '_Welcome To_ *Group Settings*'
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = " Group Welcome", callback_data='black'}, 
 ...
 text = '_به تنظیمات گروه خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = " قفل ویرایش", callback_data='black'}, 
			{text = lock_edit, callback_data="/lockedit:"..GP_id}
		},
		{
			{text = " قفل لینک", callback_data='black'}, 
			{text = lock_link, callback_data="/locklink:"..GP_id}
		},
		{
			{text = " قفل هشتگ", callback_data='black'}, 
			{text = lock_hashtags, callback_data="/lockhashtags:"..GP_id}
		},
		{
			{text = " قفل ورود", callback_data='black'}, 
			{text = lock_join, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = " قفل رگبار", callback_data='black'}, 
			{text = lock_flood, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = " قفل هرزنامه", callback_data='black'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = " قفل فراخوانی", callback_data='black'}, 
			{text = lock_mention, callback_data="/lockmention:"..GP_id}
		},
		{
			{text = " قفل فارسی", callback_data='black'}, 
			{text = lock_arabic, callback_data="/lockarabic:"..GP_id}
		},
		{
			{text = " قفل انگلیسی", callback_data='black'}, 
			{text = english, callback_data="/lockeng:"..GP_id}
		},
		{
			{text = " قفل صفحات وب", callback_data='black'}, 
			{text = lock_webpage, callback_data="/lockwebpage:"..GP_id}
		},
		{
			{text = " قفل فونت", callback_data='black'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
			{text = " قفل سنجاق کردن", callback_data='black'}, 
			{text = lock_pin, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = " قفل ربات ها", callback_data='black'}, 
			{text = lock_bots, callback_data="/lockbots:"..GP_id}
		},
		...
		{
			{text = " قفل فحش", callback_data='black'}, 
			{text = fosh, callback_data="/lockfosh:"..GP_id}
		},
		{
			{text = " قفل تبلیغات", callback_data='black'}, 
			{text = ads, callback_data="/lockads:"..GP_id}
		},
		{
			{text = " قفل تبچی", callback_data='black'}, 
			{text = lock_tabchi, callback_data="/locktabchi:"..GP_id}
		},
		{
			{text = " قفل یوزرنیم", callback_data='black'}, 
			{text = lock_username, callback_data="/lockusername:"..GP_id}
		},
		{
			{text = " قفل ایموحی", callback_data='black'}, 
			{text = emoji, callback_data="/lockemoji:"..GP_id}
		},
		{
			{text = " قفل بنر", callback_data='black'}, 
			{text = views, callback_data="/lockviews:"..GP_id}
		},
		...
		{
			{text = " خوشآمد گویی", callback_data='black'}, 
			{text = group_welcone, callback_data="/welcome:"..GP_id}
		},
		{
			{text = ' بازگشت ', callback_data = '/panel:'..GP_id}
...
local lang = redis:get(hash) 
   ...
   if not lang then
	 text = '_Welcome To_ *Group media list*'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text = " Lock Chate", callback_data='black'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id}
		},
		{
			{text = " Lock  Gifs", callback_data='black'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = " Lock  Text", callback_data='black'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id}
		},
		{
			{text = " Lock  Inline", callback_data='black'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = " Lock  Game", callback_data='black'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id}
		},
		{
			{text = " Lock  Photo", callback_data='black'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = " Lock  Video", callback_data='black'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id}
		},
		{
			{text = " Lock  Audio", callback_data='black'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = " Lock  Voice", callback_data='black'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id}
		},
		{
			{text = " Lock  Sticker", callback_data='black'}, 
			{text = mute_sticker, callback_data="/locklistticker:"..GP_id}
		},
		{
			{text = " Lock  Contact", callback_data='black'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id}
		},
		{
			{text = " Lock  Forward", callback_data='black'}, 
			{text = mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = " Lock  Location", callback_data='black'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id}
		},
		{
			{text = " Lock  Document", callback_data='black'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = " Lock  TgService", callback_data='black'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = " Lock  Keyboard", callback_data='black'}, 
   ...
   elseif lang then
	 text = '_به لیست قفلی رسانه گروه خوش آمدید_'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text = " قفل چت", callback_data='black'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id}
		},
		{
			{text = " قفل تصاویر متحرک", callback_data='black'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = " قفل متن", callback_data='black'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id}
		},
		{
			{text = " قفل اینلاین", callback_data='black'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = " قفل بازی", callback_data='black'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id}
		},
		{
			{text = " قفل عکس", callback_data='black'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = " قفل فیلم", callback_data='black'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id}
		},
		{
			{text = " قفل آهنگ", callback_data='black'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = " قفل صدا", callback_data='black'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id}
		},
		{
			{text = " قفل استیکر", callback_data='black'}, 
			{text = mute_sticker, callback_data="/locklistticker:"..GP_id}
		},
		{
			{text = " قفل مخاطب", callback_data='black'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id}
		},
		{
			{text = " قفل نقل و قول", callback_data='black'}, 
			{text = settings.mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = " قفل موقعیت", callback_data='black'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id}
		},
		{
			{text = " قفل فایل", callback_data='black'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = " قفل خدمات تلگرام", callback_data='black'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = " قفل کیبورد", callback_data='black'}, 
			{text = mute_keyboard, callback_data="/mutekeyboard:"..GP_id}
		},
		{
			{text = ' بازگشت ', callback_data = '/panel:'..GP_id}
...
local chatid = "-"..msg.query:match("%d+")
	...
	keyboard.inline_keyboard = {
		{
			{text = '> login/ورود ', callback_data = '/panel:'..chatid}
		},
		{
...
local lang = redis:get(hash) 
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		...
		{
			{text= '> Back/خروج 🔚' ,callback_data = '/panel:'..matches[2]}
		}				
	}
    edit_inline(msg.message_id, text, keyboard)
	end
	...
	if not is_mod1(matches[2], msg.from.id) then
     if not lang then
		get_alert(msg.cb_id, "You Are Not Moderator")
   elseif lang then
		get_alert(msg.cb_id, "با عرض پوزش شما دسترسی ندارید")
   end
	else
    redis:del(hash)
   sleep(1)
...
if matches[1] == '/mutegif' then
   ...
   elseif lang then
    ...
    elseif lang then
        text = 'قفل کردن تصاویر متحرک فعال شد'
    end
    ...
    elseif lang then
        text = 'قفل کردن تصاویر متحرک غیر فعال شد'
    end
...
if matches[1] == '/locklistticker' then
	if not is_mod1(matches[2], msg.from.id) then
     if not lang then
		get_alert(msg.cb_id, "You Are Not Moderator")
   elseif lang then
...
if matches[1] == '/muteforward' then
   ...
   elseif lang then
    ...
    elseif lang then
        text = 'قفل کردن نقل و قول فعال شد'
    end
    ...
    elseif lang then
        text = 'قفل کردن نقل و قول غیر فعال شد'
    end
   ...
   elseif lang then
    ...
    if not lang then
		...
		keyboard.inline_keyboard = {
			...
			{ 
				{text = "> Back To panel", callback_data="/panel:"..matches[2]}
			}
		}
   elseif lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
			...
			{ 
				{text = "> بازگشت به پنل", callback_data="/panel:"..matches[2]}
			}
		}
  end
		edit_inline(msg.message_id, text, keyboard)
...
if matches[1] == '/black' then
	...
	keyboard.inline_keyboard = {
		{
			{text = "> sam", callback_data="/sam:"..matches[2]}
		},
		{
			{text = ">canal", callback_data="/chanal:"..matches[2]}
		},
		{
			{text = '> Our GitHub ', url = 'https://www.github.com/SamTaylorUsa'}
		},
		{
			{text= '> Back 🔙' ,callback_data = '/panel:'..matches[2]}
		}				
	}
   elseif lang then
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text = "> سام", callback_data="/sam:"..matches[2]}
		},
		{
			{text = "> کانال", callback_data="/chanal:"..matches[2]}
		},
		{
			{text = '> گیت هاب تیم ', url = 'https://www.github.com/SamTaylorUsa'}
		},
		{
			{text = '> پرداخت ', url = 'http://webvps.blog.ir/post/درگاه-پرداخت-بلک'}
		},
		{
			{text= '> بازگشت 🔙' ,callback_data = '/panel:'..matches[2]}
		}				
	}
   end
    edit_inline(msg.message_id, text, keyboard)
...
if matches[1] == '/sam' then
local text = [[*》SaM Information《*
_》Age :_ *21*
_》Name :_ *Unknown*
_》City :_ *TEHRAN*
*-------------------------*
*》GitHub :《*
》[SAM TAYLOR](Github.Com/SamTaylorUsa)
*-------------------------*
*》Bridges :《*
_》Pv : _[SAM TAYLOR](Telegram.Me/GODILOVEYOUME2)
_》PvResan : _[SAM TAYLOR PvResan](Telegram.Me/teamonlineirbot)
*-------------------------*
*》Expertise :《*
...
if matches[1] == '/chanal' then
local text = [[*BLACKteam Information《*
			*》Bridges《*
			》Pv : [@TeamBlackbot_Developer](Telegram.Me/TeamBlackbot)
			*-------------------------*]]
  if not lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
